...
/**
 * Converter for {@link io.vertx.db2client.DB2AuthOptions}.
 * NOTE: This class has been automatically generated from the {@link io.vertx.db2client.DB2AuthOptions} original class using Vert.x codegen.
 */
public class MySQLAuthOptionsConverter {

  public static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, DB2AuthOptions obj) {
  ...
  public static void toJson(DB2AuthOptions obj, JsonObject json) {
    toJson(obj, json.getMap());
  }

  public static void toJson(DB2AuthOptions obj, java.util.Map<String, Object> json) {
