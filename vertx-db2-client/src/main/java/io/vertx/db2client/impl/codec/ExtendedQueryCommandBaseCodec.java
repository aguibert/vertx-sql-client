...
//  protected void sendStatementExecuteCommand(long statementId, ColumnMetaData paramsColumnDefinitions, byte sendType, Tuple params, byte cursorType) {
...
//    packet.writeIntLE(1);
//
//    int numOfParams = paramsColumnDefinitions.columns_;
